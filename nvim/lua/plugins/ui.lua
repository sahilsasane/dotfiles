      ...
      local catppuccin_options = {
        ...
        custom_highlights = function(colors)
          return {
            ...
            MiniStatuslineGit = { fg = colors.green, bg = colors.surface1, style = { 'bold' } },
            MiniStatuslineDevinfo = { fg = colors.overlay1, bg = colors.surface1 },
            MiniStatuslineFileinfo = { fg = colors.overlay1, bg = colors.surface1 },
            MiniStatuslineFilename = { fg = colors.text, bg = colors.surface1 },
