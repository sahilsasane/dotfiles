# Generated by Powerlevel10k configuration wizard on 2026-01-08 at 10:30 IST.
...
() {
  ...
  typeset -g P10K_COLOR_BASE="#1e1e2e"
  typeset -g P10K_COLOR_MANTLE="#181825"
  ...
  # Add a little breathing room between icons and text without changing terminal font settings.
  ...
  typeset -g POWERLEVEL9K_DIR_CONTENT_EXPANSION='${PWD:t}'
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # Show full local branch name without truncation.
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=$P10K_COLOR_OVERLAY2
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_FOREGROUND=$P10K_COLOR_RED
  typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND=$P10K_COLOR_OVERLAY2
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_IP${P9K_IP_RX_RATE:+ %F{#94e2d5}⇣$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %F{#fab387}⇡$P9K_IP_TX_RATE}'
