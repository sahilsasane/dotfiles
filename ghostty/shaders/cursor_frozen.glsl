...
const vec4 TRAIL_COLOR_ACCENT = vec4(0.537, 0.706, 0.980, 1.0);
const float TRAIL_OPACITY = 0.42;
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    trail = mix(fragColor, trail, TRAIL_OPACITY);
    //cursorblaze
    trail = mix(TRAIL_COLOR_ACCENT, trail, (1. - smoothstep(0., sdfCurrentCursor + .002, 0.004)) * TRAIL_OPACITY);
    trail = mix(TRAIL_COLOR, trail, (1. - smoothstep(0., sdfCurrentCursor + .002, 0.004)) * TRAIL_OPACITY);
